...
export default function ContactDeveloper() {
  return (
    <div id="contactDeveloper" className="flex flex-col gap-20 ">
      ...
      <div className="flex flex-row justify-center items-center gap-3 lg:gap-7">
        <img
          ...
          className="h-36 w-28 lg:h-72 lg:w-60 rounded-xl"
          sizes="100vw"
          alt="profile picture"
        />
        <div className="text-xl lg:text-4xl flex flex-col gap-2 lg:gap-14">
          ...
          <div className="flex flex-row flex-wrap gap-3">
            {socials.map((acc) => {
              return (
                <a href={acc.link} key={acc.id}>
                  <div className="bg-secondary p-1 rounded-xl">{acc.icon}</div>
                </a>
              );
            })}
          </div>
