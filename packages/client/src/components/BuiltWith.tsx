    ...
    <div className=" flex flex-col justify-center items-center gap-20 ">
      ...
      <div className=" flex flex-row flex-wrap gap-10 lg:gap-20 justify-center items-center">
        {builtWith &&
          builtWith.map((tech) => {
            return (
              <div className=" bg-primary p-4 px-6 lg:p-12 rounded-lg flex flex-col items-center justify-center gap-4 lg:gap-7 hover:-rotate-0 [transform:rotate3d(1_,-1,_1,_15deg)] transition-all duration-300 hover:shadow-lg [box-shadow:12px_12px_0px_0px_#0d0d0d] backdrop-filter backdrop-blur-md ">
                {tech.icon}
